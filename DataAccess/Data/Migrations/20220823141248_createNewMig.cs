        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoOfBed = table.Column<byte>(nullable: false),
                    NoOfBath = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "HeaderWhiteLogo", "logo-white.svg" },
                    { 18, "Rooms", "3" },
                    { 17, "SpaOffers", "32" },
                    { 16, "AboutPartnerEmail", "partners@hotelsochi.com" },
                    { 15, "QuestionEmail", "hello@hotelsochi.com" },
                    { 14, "AboutRightImage", "about_image_02.jpg" },
                    { 13, "AboutLeftImage", "about_image_01.jpg" },
                    { 12, "AboutSubTitle", "WELCOME TO SOCHI HOTEL" },
                    { 11, "AboutTitle", "About Sochi." },
                    { 10, "VieoNote", "Start your amazing journey." },
                    { 9, "VideoLink", "https://www.youtube.com/embed/HSsqzzuGTPo" },
                    { 8, "HeaderSubtitle", "WELCOME TO SOCHI HOTEL" },
                    { 7, "HeaderTitle", "Feeling cool like your favorite place." },
                    { 6, "ContactPhone", "+1 514.123.4567" },
                    { 5, "ContactEmail", "hello@example.com" },
                    { 4, "CityAddress", "Harbor City, CA 90710" },
                    { 3, "StreetAddress", "23400 S Western Ave," },
                    { 2, "HeaderBlackLogo", "logo-black.svg" },
                    { 19, "Beaches", "7" },
                    { 20, "HappyClients", "10" }
                });
